...
/**
 * Contains a number of methods useful for debugging and developing programs using Bencoding
 * methods.&nbsp; This class is specifically designed to be used with
 * <code>edu.rutgers.cs.cs352.bt.util.Bencoder</code> and <code>Bencoder2</code>.
 * 
...
public class ToolKit {
	 ...
	 * 
	 * @param o
	 *            the Object to print.&nbsp; It must be one of the following types: @
	 */
	...
	/**
	 * Prints the specified object with the provided depth. The depth simply indicates how much to
	 * indent.
	 * 
	 * @param o
	 *            the object to print
	...
	/**
	 * Helper method that prints out a byte string as a series of integer or ASCII characters.
	 * 
	 * @param bytes
	 *            the byte string to print.
	 * @param as_text
	 *            {@code true} if the byte string should be printed as ASCII characters
	 * @param depth
	 *            the depth of the object within other objects, used for indenting.
	 */
	 ...
	 * @param as_text
	 *            {@code true} if the {@code ByteBuffer} should be printed as ASCII characters
	 * @param depth
	 *            the depth of the object within other objects, used for indenting.
	 */
	public static void printString(ByteBuffer byte_string, boolean as_text, int depth) {
		for (int k = 0; k < depth; k++)
			System.out.print("  ");
		System.out.print("String: ");
