...
/**
 * Parses a Bencoded byte array and returns a combination of {@code Map}, {@code List},
 * {@code ByteBuffer}, and {@code Integer} objects.
 * 
...
public final class Bencoder2 {
	 ...
	 *            the bencoded metainfo dictionary.
	 * @return a {@code ByteBuffer} containing the bencoded 'info' dictionary from the metainfo
	 *         file.
	 * @throws BencodingException
	 *             if the 'info' key is not contained in the decoded dictionary.
	 */
	 ...
	 *            the bencoded data to decode.
	 * @return either a {@code Map}, {@code List}, {@code ByteBuffer}, or {@code Integer}.
	 * @throws BencodingException
	 *             if the bencoded data was improperly formatted.
	 */
	 ...
	 *            the bencoded data to decode.
	 * @param offset
	 *            the offset into {@code bencoded_bytes} at which to start decoding.
	 * @return a {@code Map}, {@code List}, {@code ByteBuffer}, or {@code Integer}.
	 * @throws BencodingException
	 *             if the bencoded object in {@code bencoded_bytes} at offset {@code offset} is
	 *             incorrectly encoded.
	 */
	 ...
	 * 
	 * @param bencoded_bytes
	 *            the byte array of the bencoded integer.
	 * @param offset
	 *            the position of the 'i' indicating the start of the bencoded integer to be
	 *            bdecoded.
	 ...
	 * @throws BencodingException
	 *             if the bencoded integer in {@code bencoded_bytes} at offset {@code offset} is
	 *             incorrectly encoded.
	 */
	private static final Object[] decodeInteger(byte[] bencoded_bytes, int offset)
		...
		for (; bencoded_bytes[offset] != (byte) 'e' && bencoded_bytes.length > (offset); offset++) {
			if ((bencoded_bytes[offset] < 48 || bencoded_bytes[offset] > 57)
				...
				throw new BencodingException("Expected an ASCII integer character, found "
						+ (int) bencoded_bytes[offset]);
			int_chars.append((char) bencoded_bytes[offset]);
		}
		try {
			offset++; // Skip the 'e'
			return new Object[]{new Integer(offset),
					new Integer(Integer.parseInt(int_chars.toString()))};
	 ...
	 * 
	 * @param bencoded_bytes
	 *            the bencoded form of the byte string.
	 * @param offset
	 *            the offset into {@code bencoded_bytes} where the byte string begins.
	 * @return an <code>Object[]</code> containing an <code>Integer</code> offset and the decoded
	 *         byte string (as a {@code ByteBuffer}), in positions 0 and 1, respectively
	 * @throws BencodingException
	 *             if the bencoded object is incorrectly encoded.
	 */
	private static final Object[] decodeString(byte[] bencoded_bytes, int offset)
			throws BencodingException {
	 ...
	 * 
	 * @param bencoded_bytes
	 *            the bencoded form of the list.
	 * @param offset
	 *            the offset into {@code bencoded_bytes} where the list begins.
	 * @return an <code>Object[]</code> containing an <code>Integer</code> offset and the decoded
	 ...
	 * 
	 * @param bencoded_bytes
	 *            the bencoded form of the dictionary.
	 * @param offset
	 *            the offset into {@code bencoded_bytes} where the dictionary begins.
	 * @return an <code>Object[]</code> containing an <code>Integer</code> offset and the decoded
	 ...
	 *            the bencoded data.
	 * @param offset
	 *            the offset into {@code bencoded_bytes} that contains a bencoded object.
	 ...
	 * 
	 * @param o
	 *            the object to bencode.
	 * @return the bencoded form of the object.
	 * @throws BencodingException
	 *             if {@code o} is not of type {@code HashMap}, {@code ArrayList}, {@code Integer},
	 *             or {@code ByteBuffer}.
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	 ...
	 * 
	 * @param list
	 *            the {@code ArrayList} to bencode.
	 * @return a {@code byte[]} containing the bencoded form of the {@code ArrayList}.
	 * @throws BencodingException
	 *             if any of the objects in the list is not bencodable.
	 */
	@SuppressWarnings("rawtypes")
	 ...
	 * 
	 * @param dictionary
	 *            the {@code HashMap} to bencode.
	 * @return a {@code byte[]} containing the bnecoded form of the {@code HashMap}.
	 * @throws BencodingException
	 *             if any of the objecdts in the map is not bencodable.
	 */
