package com.jonas.bittorrent.gui;
...
import com.jonas.bittorrent.Manager;
import com.jonas.bittorrent.Peer;
...
public class PeerDisplay extends JFrame implements Runnable {
	...
	private void updateList() {
		for (int i = 0; i < manager.peers.size(); i++) {
			...
			if (peerMap.put(new String(this.manager.peers.get(i).getPeerID()),
					this.manager.peers.get(i)) == null) {
	...
	public void displayInfo() {
		...
		if (selectedPeer.amConnected()) {
			peerInfoPanel.connected
					.setText("<html><b>Connected:</b> <font color=\"green\"> Yes </font></html>");
		} else {
			peerInfoPanel.connected
					.setText("<html><b>Connected:</b> <font color=\"red\"> No </font></html>");
		}

		if (selectedPeer.amChoking()) {
			peerInfoPanel.areChoking
					.setText("<html><b>Choked:</b> <font color=\"red\"> Choked </font></html>");
		} else {
			peerInfoPanel.areChoking
					.setText("<html><b>Choked:</b> <font color=\"green\"> Unchoked </font></html>");
		}

		if (selectedPeer.amInterested()) {
			peerInfoPanel.areInterested.setText(
					"<html><b>We're Interested:</b> <font color=\"green\"> Interested </font></html>");
		} else {
			peerInfoPanel.areInterested.setText(
					"<html><b>We're Interested:</b> <font color=\"red\"> Uninterested </font></html>");
		}

		if (selectedPeer.isChoking()) {
			peerInfoPanel.isChoking.setText(
					"<html><b>Is Choking Us:</b> <font color=\"red\"> Being Choked </font></html>");
		} else {
			peerInfoPanel.isChoking.setText(
					"<html><b>Is Choking Us:</b> <font color=\"green\"> Unchoked </font></html>");
		}

		if (selectedPeer.isInterested()) {
			peerInfoPanel.isInterested.setText(
					"<html><b>Is Interested:</b> <font color=\"green\"> Interested </font></html>");
		} else {
			peerInfoPanel.isInterested.setText(
					"<html><b>Is Interested:</b> <font color=\"red\"> Uninterested </font></html>");
		}
		...
		peerInfoPanel.uploadSpeed
				.setText("<html><b>Upload Speed:</b> " + selectedPeer.getUploadSpeed() + "</html>");
		peerInfoPanel.downloadSpeed.setText(
				"<html><b>Download Speed:</b> " + selectedPeer.getDownloadSpeed() + "</html>");
	}
