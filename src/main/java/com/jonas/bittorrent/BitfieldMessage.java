...
public class BitfieldMessage extends Message {
	...
	/**
	 * @author Robert Moore Converts an {@code boolean[]} to a {@code byte[]} where each bit of the
	 *         {@code byte[]} contains a 1 bit for a {@code true} value, and a 0 bit for a
	 *         {@code false} value. The {@code byte[]} will contain the 0th index {@code boolean}
	 *         value in the most significant bit of the 0th byte.
	 * 
	 * @param bools
	 *            an array of boolean values
	 * @return a {@code byte[]} containing the boolean values of {@code bools} as bits.
	 */
