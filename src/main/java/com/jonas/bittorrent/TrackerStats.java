...
public class TrackerStats {
	...
	/**
	 * The file that contains the statistics. Will take the form: <download file> + "stats.txt" *
	 */
	private File file;
	...
	/**
	 * Integer corresponding to the total number of bytes our client has yet to download
	 */
	private int left;
	...
	/**
	 * Creates a new TrackerStats object. Depending on whether or not the file containing statistics
	 * exists, this will do different things.
	 * 
	 * @param fileName
	 * @param torrentInfo
	 */
