 ...
 * file and stores it in public fields.&nbsp; Note that this class only works for torrent metainfo
 * files for a single-file torrent.
 * 
...
public class TorrentInfo {
	 ...
	 */
	public final static ByteBuffer KEY_INFO = ByteBuffer.wrap(new byte[]{'i', 'n', 'f', 'o'});

	/**
	 * Key used to retrieve the length of the torrent.
	 */
	public final static ByteBuffer KEY_LENGTH = ByteBuffer
			.wrap(new byte[]{'l', 'e', 'n', 'g', 't', 'h'});

	/**
	 * Key used to retrieve the piece hashes.
	 */
	public final static ByteBuffer KEY_PIECES = ByteBuffer
			.wrap(new byte[]{'p', 'i', 'e', 'c', 'e', 's'});

	/**
	 * Key used to retrieve the file name.
	 */
	public final static ByteBuffer KEY_NAME = ByteBuffer.wrap(new byte[]{'n', 'a', 'm', 'e'});

	/**
	 * Key used to retrieve the default piece length.
	 */
	public final static ByteBuffer KEY_PIECE_LENGTH = ByteBuffer
			.wrap(new byte[]{'p', 'i', 'e', 'c', 'e', ' ', 'l', 'e', 'n', 'g', 't', 'h'});

	/**
	 * ByteBuffer to retrieve the announce URL from the metainfo dictionary.
	 */
	public static final ByteBuffer KEY_ANNOUNCE = ByteBuffer
			.wrap(new byte[]{'a', 'n', 'n', 'o', 'u', 'n', 'c', 'e'});
	...
	/**
	 * The base dictionary of the torrent metainfo file.&nbsp; See <a href=
	 * "http://www.bittorrent.org/beps/bep_0003.html">http://www.bittorrent.org/beps/bep_0003.html</a>
	 * for an explanation of what keys are available and how they map.
	 */
	public final Map<ByteBuffer, Object> torrent_file_map;

	/**
	 * The unbencoded info dictionary of the torrent metainfo file.&nbsp; See <a href=
	 * "http://www.bittorrent.org/beps/bep_0003.html">http://www.bittorrent.org/beps/bep_0003.html</a>
	 * for an explanation of what keys are available and how they map.
	 */
	...
	/**
	 * The default length of each piece in bytes.&nbsp; Note that the last piece may be
	 * irregularly-sized (less than the value of piece_length) if the file size is not a multiple of
	 * the piece size.
	 */
	...
	/**
	 * Creates a new TorrentInfo object from the specified byte array. If the byte array is
	 * {@code null} or has a length of 0(zero), then an {@code IllegalArgumentException} is thrown.
	 * 
